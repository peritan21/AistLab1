...
{
    public partial class FrmMohaSutpbg : DevExpress.XtraEditors.XtraForm
    {
        private readonly BindingSource _dataSource1;
        public FrmMohaSutpbg(BindingSource dataSource)
        {
            ...
            tabSpinEdit1.DataBindings.Add(new Binding("Editvalue", dataSource, "kolbelka", true));
            tabSpinEdit2.DataBindings.Add(new Binding("Editvalue", dataSource, "kolglukoza", true));
        ...
        private void FrmMohaSutpbg_KeyUp(object sender, KeyEventArgs e)
        {
