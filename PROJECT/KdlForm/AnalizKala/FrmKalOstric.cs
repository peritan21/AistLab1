...
{
    public partial class FrmKalOstric : DevExpress.XtraEditors.XtraForm
    {
        private readonly BindingSource _dataSource1;
        public FrmKalOstric(BindingSource dataSource)
        {
            ...
            tabImageComboBoxEdit1.DataBindings.Add(new Binding("SelectedIndex", dataSource, "eostric", true));
        ...
        private void FrmKalOstricLoad(object sender, EventArgs e)
        {

        }

        private void FrmKalOstric_KeyUp(object sender, KeyEventArgs e)
        {
