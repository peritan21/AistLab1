...
{
    public partial class FrmCalglistLINQ : DevExpress.XtraEditors.XtraForm
    {
        private readonly BindingSource _dataSource1;
        public FrmCalglistLINQ(BindingSource dataSource)
        {
        ...
        private void FrmCalglistLINQ_KeyUp(object sender, KeyEventArgs e)
        {
