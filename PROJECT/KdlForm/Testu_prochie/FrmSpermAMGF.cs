...
{
    public partial class FrmSpermAMGF : DevExpress.XtraEditors.XtraForm
    {
        private readonly BindingSource _dataSource1;
        public FrmSpermAMGF(BindingSource dataSource)
        {
            ...
            tabSpinEdit1.DataBindings.Add(new Binding("Editvalue", dataSource, "amgf", true));
        ...
        private void FrmSpermAMGF_KeyUp(object sender, KeyEventArgs e)
        {
