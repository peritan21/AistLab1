...
{
    public partial class FrmPunktOnkolog : DevExpress.XtraEditors.XtraForm
    {
        private readonly BindingSource _dataSource1;
        public FrmPunktOnkolog(BindingSource dataSource)
        {
            ...
            tabTextBox1.DataBindings.Add(new Binding("Text", dataSource, "mestopunktat", true));
        ...
        private void FrmPunktOnkolog_KeyUp(object sender, KeyEventArgs e)
        {
