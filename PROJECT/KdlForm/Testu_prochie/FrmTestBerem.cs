...
{
    public partial class FrmTestBerem : DevExpress.XtraEditors.XtraForm
    {
        private readonly BindingSource _dataSource1;
        public FrmTestBerem(BindingSource dataSource)
        {
            ...
            radioGroup1.DataBindings.Add(new Binding("Editvalue", dataSource, "rezultat", true));
        ...
        private void FrmTestBerem_KeyUp(object sender, KeyEventArgs e)
        {
