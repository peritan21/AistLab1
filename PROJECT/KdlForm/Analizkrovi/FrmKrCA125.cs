...
{
    public partial class FrmKrCA125 : DevExpress.XtraEditors.XtraForm
    {
        private readonly BindingSource _dataSource1;
        public FrmKrCA125(BindingSource dataSource)
        {
            ...
            tabSpinEdit31.DataBindings.Add(new Binding("Editvalue", dataSource, "result", true));
        ...
        private void FrmKrCA125_KeyUp(object sender, KeyEventArgs e)
        {
