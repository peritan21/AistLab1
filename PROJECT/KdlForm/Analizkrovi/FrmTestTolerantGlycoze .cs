...
{
    public partial class FrmTestTolerantGlycoze : DevExpress.XtraEditors.XtraForm
    {
        private readonly BindingSource _dataSource1;
        public FrmTestTolerantGlycoze(BindingSource dataSource)
        {
            ...
            tabSpinEdit1.DataBindings.Add(new Binding("Editvalue", dataSource, "natohak", true));
            tabSpinEdit2.DataBindings.Add(new Binding("Editvalue", dataSource, "herez2hasa", true));
            tabSpinEdit3.DataBindings.Add(new Binding("Editvalue", dataSource, "herez1hasa", true));
        ...
        private void FrmTestTolerantGlycoze_KeyUp(object sender, KeyEventArgs e)
        {
