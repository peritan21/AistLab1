...
{
    public partial class FrmKrGemoliz : DevExpress.XtraEditors.XtraForm
    {
        private readonly BindingSource _dataSource1;
        public FrmKrGemoliz(BindingSource dataSource)
        {
            ...
            tabImageComboBoxEdit1.DataBindings.Add(new Binding("SelectedIndex", dataSource, "gemoliz", true));
        ...
        private void FrmKrGemoliz_KeyUp(object sender, KeyEventArgs e)
        {
