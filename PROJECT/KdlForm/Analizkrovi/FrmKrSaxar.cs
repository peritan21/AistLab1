...
{
    public partial class FrmKrSaxar : DevExpress.XtraEditors.XtraForm
    {
        private readonly BindingSource _dataSource1;
        public FrmKrSaxar(BindingSource dataSource)
        {
        ...
        private void FrmKrSaxar_KeyUp(object sender, KeyEventArgs e)
        {
