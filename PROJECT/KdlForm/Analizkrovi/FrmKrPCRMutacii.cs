...
{
    public partial class FrmKrPCRMutacii : DevExpress.XtraEditors.XtraForm
    {
        private readonly BindingSource _dataSource1;
        public FrmKrPCRMutacii(BindingSource dataSource)
        {
            ...
            tabImageComboBoxEdit1.DataBindings.Add(new Binding("SelectedIndex", dataSource, "f5", true));
            tabImageComboBoxEdit2.DataBindings.Add(new Binding("SelectedIndex", dataSource, "f2", true));
            tabImageComboBoxEdit3.DataBindings.Add(new Binding("SelectedIndex", dataSource, "mthfr", true));
            tabImageComboBoxEdit4.DataBindings.Add(new Binding("SelectedIndex", dataSource, "pai_1", true));
        ...
        private void FrmKrPCRMutacii_KeyUp(object sender, KeyEventArgs e)
        {
