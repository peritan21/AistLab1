...
{
    public partial class FrmKrOsmotRezEritr : DevExpress.XtraEditors.XtraForm
    {
        private readonly BindingSource _dataSource1;
        public FrmKrOsmotRezEritr(BindingSource dataSource)
        {
            ...
            tabSpinEdit1.DataBindings.Add(new Binding("Editvalue", dataSource, "svbegin", true));
            tabSpinEdit2.DataBindings.Add(new Binding("Editvalue", dataSource, "svend", true));
            tabSpinEdit3.DataBindings.Add(new Binding("Editvalue", dataSource, "indbegin", true));
            tabSpinEdit4.DataBindings.Add(new Binding("Editvalue", dataSource, "indend", true));
        }
        ...
        private void FrmKrOsmotRezEritr_KeyUp(object sender, KeyEventArgs e)
        {
