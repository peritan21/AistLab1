...
{
    public partial class FrmKrGemNizkogoUr : DevExpress.XtraEditors.XtraForm
    {
        private readonly BindingSource _dataSource1;
        public FrmKrGemNizkogoUr(BindingSource dataSource)
        {
            ...
            tabSpinEdit1.DataBindings.Add(new Binding("Editvalue", dataSource, "hb", true));
            tabSpinEdit2.DataBindings.Add(new Binding("Editvalue", dataSource, "gemoliz", true));
        ...
        private void FrmKrGemNizkogoUr_KeyUp(object sender, KeyEventArgs e)
        {
