...
{
    public partial class Ukrgazelektro : UserControl
    {
        private GAZUELEKTROLIT _kl;
        private DataClassesLabDataContext _db;
        public Ukrgazelektro()
        {
            InitializeComponent();
        }
        ...
        public void InitSQLData()
        {
            ...
            var res = (from c in _db.GAZUELEKTROLITs where c.pacient_id == PpacientID && c.otd == Potd select c);
        ...
        private void BindingNavigatorAddNewItemClick(object sender, EventArgs e)
        {
            ...
            _kl = (GAZUELEKTROLIT)gridView1.GetRow(sel);
            ...
            var frm = new FrmGazuElektro(eLI12BindingSource) {Llabanaliz = Llaboranth};
            frm.Text += "  " + PFIO;
            frm.InitLookup();
        ...
        public void InsertOrder(GAZUELEKTROLIT o)
        {
            _db = new DataClassesLabDataContext();
            _db.GAZUELEKTROLITs.InsertOnSubmit(o);
            try
            {
                _db.SubmitChanges(ConflictMode.ContinueOnConflict);
            }
        ...
        {
            _kl = (GAZUELEKTROLIT)eLI12BindingSource.Current;
            if (_kl == null) return;
            var frm = new FrmGazuElektro(eLI12BindingSource) {Llabanaliz = Llaboranth};
            frm.Text += "  " + PFIO;
