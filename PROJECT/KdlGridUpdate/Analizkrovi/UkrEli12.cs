...
{
    public partial class UkrEli12 : UserControl
    {
        private ELI12 _kl;
        ...
        public void InitSQLData()
        {
            ...
            var res = (from c in _db.ELI12s where c.pacient_id == PpacientID && c.otd == Potd select c);
        ...
        private void BindingNavigatorAddNewItemClick(object sender, EventArgs e)
        {
            ...
            _kl = (ELI12)gridView1.GetRow(sel);
            ...
            var frm = new FrmKrELI12(eLI12BindingSource) {Llabanaliz = Llaboranth};
            frm.Text += "  " + PFIO;
            frm.InitLookup();
        ...
        public void InsertOrder(ELI12 o)
        {
            _db = new DataClassesLabDataContext();
            _db.ELI12s.InsertOnSubmit(o);
            try
            {
                _db.SubmitChanges(ConflictMode.ContinueOnConflict);
            }
        ...
        {
            _kl = (ELI12)eLI12BindingSource.Current;
            if (_kl == null) return;
            var frm = new FrmKrELI12(eLI12BindingSource) {Llabanaliz = Llaboranth};
            frm.Text += "  " + PFIO;
