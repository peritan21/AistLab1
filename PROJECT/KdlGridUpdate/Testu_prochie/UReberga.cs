...
{
    public partial class UReberga : UserControl
    {
        private REBERGA _kl;
        ...
        public void InitSQLData()
        {
            ...
            var res = (from c in _db.REBERGAs where c.pacient_id == PpacientID && c.otd == Potd select c);
        ...
        private void BindingNavigatorAddNewItemClick(object sender, EventArgs e)
        {
            ...
            _kl = (REBERGA)gridView1.GetRow(sel);
            ...
            var frm = new FrmReberga(eLI12BindingSource) {Llabanaliz = Llaboranth};
            frm.Text += "  " + PFIO;
        ...
        public void InsertOrder(REBERGA o)
        {
            _db = new DataClassesLabDataContext();
            _db.REBERGAs.InsertOnSubmit(o);
            try
            {
                _db.SubmitChanges(ConflictMode.ContinueOnConflict);
            }
        ...
        {
            _kl = (REBERGA)eLI12BindingSource.Current;
            if (_kl == null) return;
            var frm = new FrmReberga(eLI12BindingSource) {Llabanaliz = Llaboranth};
            frm.Text += "  " + PFIO;
            frm.PZAGOLOVOK0 = PZAGOLOVOK;
